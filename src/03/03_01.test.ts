...
import {addMoneyToBudget, addMoneyToBudgetx, createMessage, repairHouse, toFireStaff, toHireStaff} from "./03_01";
...
test('Budget should be for changed for HOSPITAL', () => {
    addMoneyToBudgetx(city.governmentBuildings[0], 100000);
